<style>
    ...
    #a11y-panel * { font-size: 14px !important; color: var(--a11y-text) !important; line-height: normal !important; }

    .a11y-header { background: var(--a11y-blue); padding: 18px 20px; display: flex; justify-content: space-between; align-items: center; flex-shrink: 0; }
    ...
    .a11y-card { 
        background: var(--a11y-card) !important; border: 2px solid transparent !important; 
        border-radius: 12px !important; padding: 12px 8px; 
        display: flex; flex-direction: column; align-items: center; justify-content: center; 
        gap: 8px; cursor: pointer; box-shadow: 0 2px 6px rgba(0,0,0,0.05); 
        min-height: 90px; transition: 0.2s; position: relative; width: 100%;
    }
    ...
    .a11y-bars { display: flex; gap: 4px; width: 40px; height: 4px; margin-top: 5px; }
    ...
    .a11y-footer { padding: 15px 20px; background: white; border-top: 1px solid #dfe1e6; flex-shrink: 0; }
    .a11y-reset-btn { width: 100%; background: var(--a11y-blue); color: white !important; border: none; border-radius: 30px; padding: 14px; font-weight: 700 !important; cursor: pointer; }

    /* LOGIKA EFEK CSS (Tidak berubah) */
    ...
    body.efek-sembunyi-gambar img:not(#a11y-panel *), body.efek-sembunyi-gambar video, body.efek-sembunyi-gambar svg:not(#a11y-trigger *):not(#a11y-panel *), body.efek-sembunyi-gambar [style*="background-image"] { opacity: 0 !important; visibility: hidden !important; }
    ...
    body.efek-henti-animasi *, body.efek-henti-animasi *::before, body.efek-henti-animasi *::after { animation-duration: 0.001ms !important; transition-duration: 0.001ms !important; }
...
<div id="a11y-panel" role="dialog">
    ...
    <div class="a11y-content">
        <div class="a11y-grid-2">
            ...
            <button class="a11y-card" data-action="profil-netra"><div class="a11y-card-icon circle-bg"><svg viewBox="0 0 24 24"><path d="M12 3v18m-4-14v10m8-10v10"/></svg></div><div class="a11y-card-title">Netra</div></button>
            ...
            <button class="a11y-card" data-action="profil-disleksia"><div class="a11y-card-icon circle-bg" style="font-weight:bold; font-size:18px!important;">Df</div><div class="a11y-card-title">Disleksia</div></button>
        </div>

        <hr style="border:none; border-top:1px solid #dfe1e6;">

        <div class="a11y-grid-3">
            <button class="a11y-card" data-action="efek-teks-besar" data-steps="4"><div class="a11y-card-icon" style="font-weight:bold; font-size:20px!important;">T+</div><div class="a11y-card-title">Teks+</div><div class="a11y-bars"><div class="a11y-bar"></div><div class="a11y-bar"></div><div class="a11y-bar"></div><div class="a11y-bar"></div></div></button>
            <button class="a11y-card" data-action="efek-teks-kecil" data-steps="4"><div class="a11y-card-icon" style="font-weight:bold; font-size:16px!important;">t-</div><div class="a11y-card-title">Teks-</div><div class="a11y-bars"><div class="a11y-bar"></div><div class="a11y-bar"></div><div class="a11y-bar"></div><div class="a11y-bar"></div></div></button>
            <button class="a11y-card" data-action="efek-desaturasi" data-steps="3"><div class="a11y-card-icon"><svg viewBox="0 0 24 24"><path d="M12 21c-3.87 0-7-3.13-7-7 0-4.33 6-11 7-11s7 6.67 7 11c0 3.87-3.13 7-7 7z"/></svg></div><div class="a11y-card-title">Warna</div><div class="a11y-bars"><div class="a11y-bar"></div><div class="a11y-bar"></div><div class="a11y-bar"></div></div></button>
            ...
            <button class="a11y-card" data-action="efek-sembunyi-gambar"><div class="a11y-card-icon"><svg viewBox="0 0 24 24"><path d="M21 19V5c0-1.1-.9-2-2-2H5.83L21 18.17zM2.81 2.81L1.39 4.22 3 5.83V19c0 1.1.9 2 2 2h13.17l1.61 1.61 1.41-1.41L2.81 2.81z"/></svg></div><div class="a11y-card-title">No Foto</div></button>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // DRAG LOGIC (Support Touch & Mouse)
    ...
    function startDrag(e) {
        ...
        sx = clientX - trigger.offsetLeft;
        sy = clientY - trigger.offsetTop;
    }
    ...
    function doDrag(e) {
        ...
        const clientX = e.touches ? e.touches[0].clientX : e.clientX;
        const clientY = e.touches ? e.touches[0].clientY : e.clientY;
        trigger.style.left = (clientX-sx)+'px';
        trigger.style.top = (clientY-sy)+'px';
