...
<div id="a11y-panel" role="dialog">
    ...
    <div class="a11y-content">
        ...
        <div class="a11y-grid-3">
            ...
            <button class="a11y-card" data-action="efek-teks-kecil" data-steps="2"><div class="a11y-card-icon" style="font-size:20px">T<span>T</span></div><div class="a11y-card-title">Perkecil Teks</div><div class="a11y-bars"><div class="a11y-bar"></div><div class="a11y-bar"></div></div></button>
            ...
            <button class="a11y-card" data-action="efek-rata-kiri"><div class="a11y-card-icon"><svg viewBox="0 0 24 24"><path d="M3 21h18v-2H3v2zm0-4h12v-2H3v2zm0-4h18v-2H3v2zm0-4h12V7H3v2zm0-6v2h18V3H3z"/></svg></div><div class="a11y-card-title">Rata Tulisan</div></button>
            ...
            <button class="a11y-card" data-action="efek-kursor-besar" data-steps="1"><div class="a11y-card-icon"><svg viewBox="0 0 24 24" style="transform:rotate(-45deg)"><path d="M7 2l12 11.2-5.8.5 3.3 7.3-2.2.9-3.2-7.4-4.4 4.7z"/></svg></div><div class="a11y-card-title">Kursor</div><div class="a11y-bars" style="width:20%"><div class="a11y-bar"></div></div></button>
        ...
        card.addEventListener('click', () => {
            if(aksi.startsWith('profil-')) {
                ...
                Object.entries(profilCfg[aksi]).forEach(([f, l]) => {
                    ...
                    if(b) { b.dataset.currentStep = l; b.classList.add('aktif'); if(b.dataset.steps) b.classList.add('step-'+l); terapkan(f, l); }
                });
            } else {
